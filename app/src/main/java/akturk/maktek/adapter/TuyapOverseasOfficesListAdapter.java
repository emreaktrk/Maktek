...
public final class TuyapOverseasOfficesListAdapter extends ArrayAdapter<Office> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.cell_tuyap_overseas_offices, parent, false);

            tempViewHolder = new ViewHolder();
            tempViewHolder.mNameTextView = (RobotoCondensedBoldTextView) convertView.findViewById(R.id.cell_tuyap_overseas_offices_name_textview);
            tempViewHolder.mContactTextView = (RobotoCondensedRegularTextView) convertView.findViewById(R.id.cell_tuyap_overseas_offices_contact_textview);
            tempViewHolder.mAdressTextView = (RobotoCondensedRegularTextView) convertView.findViewById(R.id.cell_tuyap_overseas_offices_adress_textview);
            tempViewHolder.mPhoneTextView = (RobotoCondensedRegularTextView) convertView.findViewById(R.id.cell_tuyap_overseas_offices_phone_textview);
            tempViewHolder.mFaxTextView = (RobotoCondensedRegularTextView) convertView.findViewById(R.id.cell_tuyap_overseas_offices_fax_textview);
            tempViewHolder.mMailTextView = (RobotoCondensedRegularTextView) convertView.findViewById(R.id.cell_tuyap_overseas_offices_email_textview);
            tempViewHolder.mPhoneImageView = (VerticallySquaredImageView) convertView.findViewById(R.id.cell_tuyap_overseas_offices_phone_imageview);
            tempViewHolder.mMailImageView = (VerticallySquaredImageView) convertView.findViewById(R.id.cell_tuyap_overseas_offices_email_imageview);
