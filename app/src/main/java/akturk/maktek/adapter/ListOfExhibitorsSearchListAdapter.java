...
public final class ListOfExhibitorsSearchListAdapter extends ArrayAdapter<Exhibitor> implements Filterable {
    ...
    public ListOfExhibitorsSearchListAdapter(Context context, List<Exhibitor> objects) {
