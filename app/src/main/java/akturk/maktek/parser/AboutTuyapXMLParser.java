...
public final class AboutTuyapXMLParser {
    private ArrayList<Paragraph> mList;
    private Context mContext;

    public AboutTuyapXMLParser(Context context) {
    ...
    private void parseXML() {
        XmlPullParser tempPullParser = mContext.getResources().getXml(R.xml.about_tuyap);
